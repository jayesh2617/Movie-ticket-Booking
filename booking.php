            ...
            <div class="section group">
                <div class="about span_1_of_2">
                    ...
                    <table class="table table-hover table-bordered text-center">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="col-md-12 text-center" style="padding-bottom:20px">
                                    ...
                                    <?php if ($date != date('Y-m-d', strtotime($_SESSION['dd'] . " +4 days"))) { ?><a href="booking.php?date=<?php echo date('Y-m-d', strtotime($date . " +1 days")); ?>"><button class="btn btn-default"><i class="glyphicon glyphicon-chevron-right"></i></button></a><?php }
                        ...
                        <tr>
                            <td>Amount</td>
                            <td id="amount" style="font-weight:bold;font-size:18px">Rs <?php echo $screen['charge']; ?></td>
                        </tr>
                        <tr>
                            <td colspan="2">
